...
export default function MealCalendar({ currentDate, records }) {
 ...
 for (let i = 0; i < 7; i++) {
 days.push(
 <div key={i} className="text-left font-medium text-[10px] uppercase tracking-widest text-foreground dark:text-foreground py-2 pl-2">
 ...
 >
 <div className={`text-xs sm:text-sm font-medium w-6 h-6 flex items-center justify-center rounded-full ${isCurrentMonth ?'text-foreground':'text-foreground'}`}>
 {formattedDate}
 </div>
 ...
 <div className="bg-background p-4 rounded-xl border border-border dark:border-white/10 flex items-center justify-between">
 <div className="flex flex-col">
 <span className="text-[10px] uppercase tracking-widest text-foreground dark:text-foreground font-semibold mb-1">Consumption</span>
 <span className="text-sm font-medium text-foreground">
 <span className="text-2xl font-bold">{consumedCount}</span> meals
 </span>
 </div>
 <div className="text-right flex flex-col">
 <span className="text-[10px] uppercase tracking-widest text-foreground dark:text-foreground font-semibold mb-1">Active Days</span>
 <span className="text-sm font-medium text-foreground">
 ...
 <div className="bg-background p-4 rounded-xl border border-border dark:border-white/10 flex flex-col justify-center gap-3">
 <span className="text-[10px] uppercase tracking-widest text-foreground dark:text-foreground font-semibold">Legend</span>
 <div className="flex flex-wrap items-center gap-4 text-xs font-medium">
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded bg-background dark:bg-white"></div>
 <span className="text-foreground">Consumed</span>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded bg-secondary border border-border dark:border-white/5"></div>
 <span className="text-foreground dark:text-foreground">Selected / Skipped</span>
 </div>
 </div>
 </div>
 </div>

 <div className="bg-background p-4 sm:p-6 rounded-xl border border-border dark:border-white/10">
 {renderDays()}
 {renderCells()}
 </div>
 </div>
