    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-base font-medium text-[#111111] dark:text-white">Additional Charges</h3>
          <button
            onClick={() => setIsAdding(!isAdding)}
            className="text-xs uppercase tracking-widest font-medium text-[#111111] dark:text-white hover:opacity-70 transition-opacity flex items-center gap-1"
          >
        ...
        <div className="space-y-2">
          {subcharges.map((charge) => (
            <div key={charge.id} className="flex justify-between items-center py-2 border-b border-black/5 dark:border-white/5 last:border-0 group">
              <div className="flex items-center gap-3">
                <button
                  ...
                  title="Remove charge"
                >
                  <X className="w-3.5 h-3.5 text-[#737373] dark:text-[#a0a0a0]" />
                </button>
                <span className="text-sm font-medium text-[#111111] dark:text-white">{charge.name}</span>
              </div>
              <div className="text-sm text-[#737373] dark:text-[#a0a0a0] tabular-nums">
