...
export default function MealHistoryDashboard() {
 ...
 className="mr-auto sm:mr-4 flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-xl text-sm font-medium hover:bg-black dark:hover:bg-gray-100 transition-colors shadow-sm active:scale-95"
 >
 <Calculator className="w-4 h-4"/>
 Estimate Bill
 </button>

 <div className="text-base font-medium text-foreground hidden sm:block">
 ...
 <div className="bg-background rounded-xl shadow-xl w-full max-w-xl border border-border dark:border-white/10 my-8 flex flex-col max-h-[90vh]">
 <div className="flex justify-between items-center p-6 border-b border-border dark:border-white/5 shrink-0">
