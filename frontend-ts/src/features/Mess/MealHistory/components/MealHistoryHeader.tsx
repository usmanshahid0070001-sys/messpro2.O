  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5">
        <div className="flex flex-col gap-2 sm:gap-0 flex-1">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto shrink-0 w-full sm:w-auto">
          <button
            ...
            className="inline-flex w-full sm:w-auto justify-center items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold rounded-xl bg-purple-600 hover:bg-purple-700 text-white transition-all shadow-xs active:scale-95 cursor-pointer"
          >
      ...
      <div className="bg-card border border-border p-3 sm:p-4 rounded-2xl shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 w-full sm:w-auto">
            <div className="flex items-center p-1 bg-muted/60 rounded-xl border border-border/80 shadow-2xs w-full sm:w-auto">
              <button
                type="button"
                onClick={onPrevMonth}
              ...
              <div className="flex-1 px-3 py-1 font-bold text-xs sm:text-sm text-foreground flex items-center gap-2 min-w-[130px] justify-center font-mono">
            ...
            {!isCurrentMonth && (
              <button
                ...
                className="inline-flex w-full sm:w-auto justify-center items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-xl bg-muted/60 hover:bg-muted border border-border/80 text-foreground transition-colors shadow-2xs cursor-pointer"
              >
          ...
          <div className="flex items-center p-1 bg-muted/60 rounded-xl border border-border/80 w-full sm:w-auto shadow-2xs">
            <button
              type="button"
