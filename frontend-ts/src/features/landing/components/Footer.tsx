    ...
    <footer className="bg-background border-t border-border/80 dark:border-white/10 pt-16 pb-12 text-xs relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-sm">
              The complete management platform for student residences, private hostels, and dining mess operations. Built for speed, audit compliance, and zero ledger disputes.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                <Link to="/login" className="hover:text-foreground transition-colors">
                  Cleaning Logs & Service
                </Link>
              </li>
              <li>
                <Link to="/login" className="hover:text-foreground transition-colors">
                  Automated Billing & PDF
                </Link>
              </li>
              <li>
                <Link to="/login" className="hover:text-foreground transition-colors">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex items-center gap-1.5">
                ...
                <a href="mailto:support@messpro.io" className="hover:text-foreground transition-colors">
                  support@messpro.io
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border/60 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-muted-foreground text-[11px]">
          <div>
            &copy; {new Date().getFullYear()} MessPro. All rights reserved.
          </div>

          <div className="flex items-center gap-1">
            <span>Built with precision for smart hostel living</span>
          </div>
        </div>
